...
def run():
    ...
    E_spikes, I_spikes = gen_realistic_inputs(Tmax=100)
    #
    X_e = spikes_to_input(E_spikes, Tmax=1600)
    X_i = spikes_to_input(I_spikes, Tmax=1600)
    ...
    # save data
    np.savez_compressed('/scratch/eap40/val_tu_1n4', a=target_params_list, b=trained_params_list, c=inputs)
