...
def run():
    ...
    target_params_list, trained_params_list = validate_fit(target_model=hln_1l_tied, num_sims=5, inputs=inputs)
    ...
    # save data
    np.savez_compressed('/scratch/eap40/val_tied_1lt', a=target_params_list, b=trained_params_list, c=inputs)
